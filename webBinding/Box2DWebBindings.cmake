...
SET(CMAKE_CXX_FLAGS_CHECKED "-std=c++17 -g3 -gdwarf-2 -O3")
SET(CMAKE_CXX_FLAGS_PROFILE "-std=c++17 -O3 -g")
...
add_library(Box2DWebBindings STATIC ${BOX2D_WEB_BINDINGS_SOURCE})

add_custom_command(TARGET Box2DWebBindings POST_BUILD
        COMMAND emar -x libbox2d.${CMAKE_BUILD_TYPE}.a
        COMMAND emar -x libbox2d.a
        COMMAND emar -rcs libbox2d-fat.${CMAKE_BUILD_TYPE}.a *.o
        COMMAND ${CMAKE_COMMAND} -E remove *.o
        WORKING_DIRECTORY ${PROJECT_SOURCE_DIR}/BUILD_WASM/bin
